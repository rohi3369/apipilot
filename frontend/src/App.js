...
import PrivateApiManager from './PrivateApiManager';
    ...
    <div className="app-container">
      <header className="navbar">
        ...
        <nav className="navbar-nav">
          ...
          {authService.isAdmin() && (
            <button 
              className={`nav-link ${currentView === 'private-apis' ? 'active' : ''}`}
              onClick={() => setCurrentView('private-apis')}
            >
              Private APIs
            </button>
          )}
      ...
      <main className="content-area">
        {currentView === 'dashboard' ? <ProtectedApp /> : 
         currentView === 'tester' ? <ApiTester /> : 
         currentView === 'private-apis' ? <PrivateApiManager /> : 
         <ProtectedApp />}
      </main>
    </div>
  );
